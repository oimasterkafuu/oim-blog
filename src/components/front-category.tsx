...
interface FrontCategoryProps {
  slug: string
  initialPage?: number
}

export function FrontCategory({ slug, initialPage = 1 }: FrontCategoryProps) {
  ...
  return (
    <FrontLayout categories={categories} pages={pages}>
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">分类: {categoryName || slug}</h1>
